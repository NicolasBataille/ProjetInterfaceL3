...
public class Test {
	...
	public static void main(String[] args) {
		try {
			...
			//PLAY ...
			//
			HashMap<Integer, Coup> mapDev = loadCoupsFromFile("./src/main/resources/train_dev_test/dev.txt");
			...
			//
			HashMap<Integer, Coup> mapTest = loadCoupsFromFile("./src/main/resources/train_dev_test/test.txt");
